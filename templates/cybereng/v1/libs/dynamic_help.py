...
.NOTES
    ...
    [Latest Author]
        o Michael Arroyo
    [Latest Build Version]
        o 1.1.1.20250104 (Major.Minor.Patch.Date<YYYYMMDD>)
    [Comments]
        o
    [Python Compatibility / Tested On]
        o Python 3.13.1
...
.BUILD NOTES
    ...
    o 1.1.1.20250104
        [Michael Arroyo] Bug fix for Module not found error
        [Michael Arroyo] Remove for required module parameter.  The default is now the current module.
...
if __name__ == "__main__":
    ...
    parser.add_argument('-m', '--module', type=str, help='The module or function to parse')
